...
* [`src/com/danielmartincraig/cardesigner/styles.cljs`](src/com/danielmartincraig/cardesigner/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/com/danielmartincraig/cardesigner/`](src/com/danielmartincraig/cardesigner/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/com/danielmartincraig/cardesigner/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `com.danielmartincraig.cardesigner` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/com/danielmartincraig/cardesigner/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns com.danielmartincraig.cardesigner.example
  (:require [com.danielmartincraig.cardesigner.config :as config])
